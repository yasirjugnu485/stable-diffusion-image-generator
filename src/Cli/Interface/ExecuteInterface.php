...
interface ExecuteInterface
{
     ...
     * @var string
     */
    const string ECHO_GENERATE_IMAGE_WITH_PROMPT = 'Call Stable Diffusion txt2img API to generating image with prompt:' . PHP_EOL . '"%1$s"' . PHP_EOL . 'and negative prompt:' . PHP_EOL . '"%2$s"';
     ...
     * @var string
     */
    const string ECHO_GENERATE_IMAGE_WITH_PROMPT_AND_IMAGE = 'Call Stable Diffusion img2img API to generating image with prompt:' . PHP_EOL . '"%1$s"' . PHP_EOL . 'and negative prompt:' . PHP_EOL . '"%2$s"' . PHP_EOL . 'and image: "%3$s"';
     ...
     * @var string
     */
    const string ERROR_GENERATE_IMAGE_WITH_PROMPT = 'Error generating image with prompt::' . PHP_EOL . '"%1$s"' . PHP_EOL . 'and negative prompt:' . PHP_EOL . '"%2$s"';
     ...
     * @var string
     */
    const string ERROR_GENERATE_IMAGE_WITH_PROMPT_AND_IMAGE = 'Error generating image with prompt:' . PHP_EOL . '"%1$s"' . PHP_EOL . 'and negative prompt:' . PHP_EOL . '"%2$s"' . PHP_EOL . 'and image: "%3$s"';
