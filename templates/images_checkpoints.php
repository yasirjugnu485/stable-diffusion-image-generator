...
if (count($params['data'])) {
    ...
    <div id="modal-lightbox" class="modal">
        ...
        <div class="modal-content">
            ...
            <?php
            $index = 1;
            foreach ($params['data'] as $checkpoint => $payloads) {
                foreach ($payloads['payloads'] as $image) {
...
<?php include(ROOT_DIR . 'templates/checkpoints.php'); ?>
