                ...
                <form method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            ...
                            <div class="form-text">
                                Creates a txt2txt -> img2img or img2img -> img2img loop, depending on the mode option.
                                Creates the first image with the configured mode and all subsequent images as img2img
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            ...
                            <div class="form-text">
                                The Mode to use. Can be txt2img or img2img. If img2img is selected, the Stable Diffusion
                                img2img settings has to set correctly and the init images directory has to be set.
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            ...
                            <div class="form-text">
                                Multiple Checkpoints (Models) can be selected, rotating with each new image generation.
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            ...
                            <div class="form-text">
                                Multiple Samplers can be selected, rotating with each new image generation. If none are
                                chosen, the default Sampler (Euler) is applied. Please note that not all Checkpoints
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            ...
                            <div class="form-text">
                                In img2img Mode, all images in the Initialize Images Directories must share the same
                                aspect ratio.
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            ...
                            <div class="form-text">
                                Multiple Refiner Checkpoints (Models) can be selected, rotating with each new image
                        ...
                        if ($params['upscalers']) {
                            ...
                            <div class="col-12 col-md-6 mb-4<?php if (!$params['config']['enableHr']) {
                                ...
                                <div class="form-text">
                                    Width of the resized image. Only available if hires fix is enabled and hr scale is
                                    not configured or 0.
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6 mb-4<?php if (!$params['config']['enableHr']) {
                                ...
                                <input type="number"
                                       ...
                                       onchange="generator.hrSizeOnchange()">
                                <div class="form-text">
                                    Height of the resized image. Only available if hires fix is enabled and hr scale is
                                    not configured or 0.
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6 mb-4<?php if (!$params['config']['enableHr']) {
                                ...
                                <div class="form-text">
                                    Scale of the resized image. Only available if hires fix is enabled. Overrides Resize
                            ...
                            <div class="col-12 col-md-6 mb-4<?php if (!$params['config']['enableHr']) {
                                ...
                                <div class="form-text">
                                    If none are chosen, the default Sampler (Euler) is applied. Please note that not all
    ...
    class Generator
    {
        ...
        enableHrOnchange = () => {
            if (document.getElementById("enableHr").value === "1") {
                ...
                document.querySelectorAll('[data-type="enableHrOnchange"]').forEach(function (element) {
